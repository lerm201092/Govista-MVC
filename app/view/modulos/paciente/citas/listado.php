                        ...
                        <div class="tab-pane active p-4" id="tab1">
                            <table id="tbl-pacientes" class="table table-sm table-striped table-bordered">
                                <thead class="text-primary">
                                    <th class="d-none d-sm-none d-md-block">Fecha</th>
                                    <th>Medico</th>
    ...
    function listar_pacientes(pagina){
        ...
        .then(resp => {
            ...
            for(var i=0; i < resp.citas.length; i++){
                html+="<tr>";
                html+="<td  class='d-none d-sm-none d-md-table-cell '>"+resp.citas[i].start+"</td>";
                html+="<td>"+resp.citas[i].name+"</td>";
                html+="<td>"+resp.citas[i].desc_corta+"</td>";
                html+="<td class='pl-3'>";
                    html+="<a href='/apps/rol-paciente/citas/ver/"+resp.citas[i].cita_id+"' title='Ver Paciente'><i class='cl-azul fas fa-eye'></i></a>";
                html+="</td>";
                html+="</tr>";
            }
