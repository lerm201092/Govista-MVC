                    ...
                    <div class="row">
                        ...
                        <div class="col-9 pl-0 pr-2">
                            <div class="text-right">
                                ...
                                <p id="pacientesActivos" class="valores-cajas">0</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 pl-0 pr-2">
                            <div class="text-right">
                                ...
                                <p id="pacientesInactivos" class="valores-cajas">0</p>
                            </div>
                        </div>
                    </div>
...
<!-- scripts -->
    <script>
        ...
        .then(resp => {
            $("#totalPacientes").text(resp["totalPacientes"]);
            $("#pacientesActivos").text(resp["pacientesActivos"]);
            $("#pacientesInactivos").text(resp["pacientesInactivos"]);
        ...
        function cargarGraficos(resp){
            ...
            series: [
                {
                data: [ resp["totalPacientes"], resp["pacientesActivos"], resp["pacientesInactivos"], resp["citasActivas"]]
                }
            ]
            };
