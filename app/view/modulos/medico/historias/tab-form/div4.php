        ...
        <div id="div_fil_oft" style="width:95%; margin:0 auto">
            ...
            <div class="row border p-0 pb-4 mt-4">             
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <input type="number" class="mat-input" name="fo_ofmeri2_oi" />
                        <!-- {!! Form::number('fo_ofmeri2_oi', null, array('class' => 'mat-input')) !!} -->
                    </div>
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <input type="number" class="mat-input" name="fo_ofmeri2_od" />
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_ofeje_oi">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                         <select class="mat-input p-1" name="fo_ofeje_od">
                            <?php foreach(CONSTANTES['eje'] as $key=>$value): ?>
                            <option value="<?=($key)?>"><?=($value)?><?php if($value): ?>&#176;<?php endif; ?> </option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <input type="text" class="mat-input" name="fo_ofobser_oi" />
                        <!-- {!! Form::text('fo_ofobser_oi', null, array('class' => 'mat-input')) !!} -->
                    </div>
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <input type="text" class="mat-input" name="fo_ofobser_od" />
        ...
        <div id="div_fil_ret" style="width:95%; margin:0 auto">
            ...
            <div class="row border p-0 pb-4 mt-4">             
                <div class="col-lg-2 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_retesf_oi">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_retesf_od">
                            <?php foreach(CONSTANTES['esfera_cilindro'] as $key=>$value): ?>
                                <option value="<?=($key)?>"><?=($value)?></option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="col-lg-2 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_retcil_oi">
                            <?php foreach(CONSTANTES['esfera_cilindro'] as $key=>$value): ?>
                                <option value="<?=($key)?>"><?=($value)?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_retcil_od">
                            <?php foreach(CONSTANTES['esfera_cilindro'] as $key=>$value): ?>
                                <option value="<?=($key)?>"><?=($value)?></option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="col-lg-2 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_reteje_oi">
                            <?php foreach(CONSTANTES['eje'] as $key=>$value): ?>
                            <option value="<?=($key)?>"><?=($value)?><?php if($value): ?>&#176;<?php endif; ?> </option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_reteje_od">
                            <?php foreach(CONSTANTES['eje'] as $key=>$value): ?>
                            <option value="<?=($key)?>"><?=($value)?><?php if($value): ?>&#176;<?php endif; ?> </option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="col-lg-4 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <input type="text" class="mat-input" name="fo_retobserv_od" />
        ...
        <div id="div_fil_tpsub" style="width:95%; margin:0 auto">
            ...
            <div class="row border p-0 pb-4 mt-4">             
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_tsubesf_oi">
                            <?php foreach(CONSTANTES['esfera_cilindro'] as $key=>$value): ?>
                                <option value="<?=($key)?>"><?=($value)?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_tsubesf_od">
                            <?php foreach(CONSTANTES['esfera_cilindro'] as $key=>$value): ?>
                                <option value="<?=($key)?>"><?=($value)?></option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_tsubcil_oi">
                            <?php foreach(CONSTANTES['esfera_cilindro'] as $key=>$value): ?>
                                <option value="<?=($key)?>"><?=($value)?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_tsubcil_od">
                            <?php foreach(CONSTANTES['esfera_cilindro'] as $key=>$value): ?>
                                <option value="<?=($key)?>"><?=($value)?></option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_tsubeje_oi">
                            <?php foreach(CONSTANTES['eje'] as $key=>$value): ?>
                            <option value="<?=($key)?>"><?=($value)?><?php if($value): ?>&#176;<?php endif; ?> </option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_tsubeje_od">
                            <?php foreach(CONSTANTES['eje'] as $key=>$value): ?>
                            <option value="<?=($key)?>"><?=($value)?><?php if($value): ?>&#176;<?php endif; ?> </option>
                            <?php endforeach ?>
                        </select>
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <input type="number" class="mat-input" name="fo_tsubpris_oi" />
                        <!-- {!! Form::number('fo_tsubpris_oi', null, array('class' => 'mat-input')) !!} -->
                    </div>
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <input type="number" class="mat-input" name="fo_tsubpris_od" />
            ...
            <div class="row border p-0 pb-4 mt-4">             
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <input type="number" class="mat-input" name="fo_tsubbase_oi" />
                        <!-- {!! Form::number('fo_tsubbase_oi', null, array('class' => 'mat-input')) !!} -->
                    </div>
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <input type="number" class="mat-input" name="fo_tsubbase_od" />
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <input type="number" class="mat-input" name="fo_tsubadd_oi"/>
                        <!-- {!! Form::number('fo_tsubadd_oi', null, array('class' => 'mat-input')) !!} -->
                    </div>
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <input type="number" class="mat-input" name="fo_tsubadd_od"/>
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_tsubavc_vl_oi">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_tsubavc_vl_od">
                                    <?php foreach(CONSTANTES['sc'] as $key=>$value): ?>
                                        <option value="<?=($key)?>"><?=($value)?></option>
                                    <?php endforeach ?>
                                </select>
                ...
                <div class="col-lg-3 m-0 p-0">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Izquierdo</label>
                        <select class="mat-input p-1" name="fo_tsubavc_vp_oi">
                    ...
                    <div class="mat-div mx-2 is-completed">
                        <label for="first-name" class="mat-label text-center">Ojo Derecho</label>
                        <select class="mat-input p-1" name="fo_tsubavc_vp_od">
                                    <?php foreach(CONSTANTES['cc'] as $key=>$value): ?>
                                        <option value="<?=($key)?>"><?=($value)?></option>
                                    <?php endforeach ?>
                                </select>
