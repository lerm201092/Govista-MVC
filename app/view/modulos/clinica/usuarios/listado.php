...
<?php include "../../../layouts/clinica/inicio.php";?>
<!-- head -->
<style>
...
<!-- / head -->
<?php include "../../../layouts/clinica/body.php";?>
    ...
    <div class="col-12 card px-0">
        ...
        <div class="card-body">
                ...
                <div class="row justify-content-end mb-3">
                    <a href="/apps/rol-clinica/usuarios/nuevo" class="btn bg-verde text-light font-weight-bold float-right mx-1"><span class="fas fa-user-check mr-2"></span>Nuevo Usuario</a>  
                </div>
...
<!-- / Contenedor de la pagina -->
<?php include "../../../layouts/clinica/footer.php";?>
<!-- scripts -->
<script>
    ...
    function listar(pagina){
        ...
        fetch(url, miInit).then(res => res.json()).catch(error =>  {
            ...
            for(var i=0; i < resp.usuarios.length; i++){
                ...
                html+="<td>";
                    if( (resp.usuarios[i].roluser == 3) || (resp.usuarios[i].roluser == 4) ){
                        html+="<a disabled href='/apps/rol-clinica/usuarios/ver/"+resp.usuarios[i].id+"' class='cl-azul mx-1'><i class='fas fa-eye'></i></a>";
                        html+="<a disabled href='/apps/rol-clinica/usuarios/editar/"+resp.usuarios[i].id+"' class='cl-amarillo mx-1 mr-2'><i class='fas fa-edit'></i></a>  ";
            ...
            if((pass1 == pass2)){
                ...
                fetch(url, miInit).then(res => res.json()).catch(error =>  {
                    ...
                    if(resp == "OK"){
                        ...
                        setTimeout(() => { location.href = "/apps/rol-clinica/usuarios/listado";  }, 3000);
                    }else{
                        console.error(resp);
...
<!-- / scripts -->
<?php include "../../../layouts/clinica/fin.php";?>