				...
				<form id="form-usuarios" action="javascript:void(0)" onsubmit="guardar()">
                    ...
                    <div class="row pt-4">
						<div class="col-12 text-right">
							<a href="/apps/rol-clinica/usuarios/listado" class="btn btn-secondary text-light "><span class="fas fa-caret-left mr-2"></span>Regresar</a>
    ...
    function guardar(){      
        ...
        fetch(url, miInit).then(res => res.json()).catch(error =>  {
            ...
            if(resp=="OK"){
                ...
                setTimeout(() => {
                    location.href = "/apps/rol-clinica/usuarios/listado";
                }, 3000);
            }else{
