    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item" id="li-resumen">
                <a href="/apps/rol-medico/estadisticas/resumen" class="nav-link">
            ...
            <li class="nav-item" id="li-pacientes">
                <a href="/apps/rol-medico/pacientes/listado" class="nav-link">
            ...
            <a href="/apps/rol-medico/citas/listado" class="nav-link">
            ...
            <a href="/apps/rol-medico/historias/listado" class="nav-link">
