  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
        ...
        <nav class="mt-2">
            ...
            <a href="/apps/rol-paciente/citas/listado" class="nav-link">
            ...
            <a href="/apps/rol-paciente/ejercicios/listado" class="nav-link">
                <span class="nav-icon fas fa-gamepad"></span>
                <p>
                    Ejercicios
                </p>
                </a>
