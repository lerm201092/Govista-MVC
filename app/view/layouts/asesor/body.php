    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
        ...
        <div class="user-panel pb-3 mb-3 d-flex">
            <div class="info col-12 text-center">
                <a href="#" class="d-block"><b>Asesor Comercial</b></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item" id="li-resumen">
                <a href="/apps/rol-administrador/estadisticas/resumen" class="nav-link">
            ...
            <li class="nav-item has-treeview" >
                <a href="#" class="nav-link" id="li-medico">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item item-hijo ">
                        <a href="/apps/rol-asesor/citas/listado" class="nav-link">
                            <i class="fas fa-sort-amount-down nav-icon"></i>
                            <p>Citas</p>
                        </a>
                    </li>
                    <li class="nav-item item-hijo ">
                        <a href="/apps/rol-asesor/historias/ver" class="nav-link">
                            <i class="fas fa-sort-amount-down nav-icon"></i>
            ...
            <li class="nav-item" id="li-ejercicios">
                <a href="/apps/rol-asesor/ejercicios/listado" class="nav-link">
                    <span class="nav-icon fas fa-building"></span>
                    <p>
                        Ejercicios
                    </p>
